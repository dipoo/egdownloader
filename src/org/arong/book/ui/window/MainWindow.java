...
import org.arong.book.ini.Configuration;
import org.arong.book.ini.IniException;
import org.arong.book.ini.IniPropertyValidator;
import org.arong.book.ini.SiteInfo;
import org.arong.book.ui.ComponentConst;
import org.arong.book.ui.SwingPrintStream;
import org.arong.book.ui.listener.MenuMouseListener;
import org.arong.book.ui.swing.AJButton;
import org.arong.book.ui.swing.AJComboBox;
import org.arong.book.ui.swing.AJLabel;
import org.arong.book.ui.swing.AJMenu;
import org.arong.book.ui.swing.AJMenuBar;
import org.arong.book.ui.swing.AJTextField;
import org.arong.book.ui.work.CollectWork;
import org.arong.book.ui.work.UpdateSiteWork;
import org.arong.book.version.Version;
...
public class MainWindow extends JFrame implements ActionListener {
	...
	public MainWindow() {
		try {
			...
			siteNames = Configuration.getSiteNames();
		...
		typeLabel = new AJLabel(ComponentConst.TYPENAME_LABEL_TEXT, Color.BLUE,
				220, 40, 60, 30);
		// 设置两个下拉框的位置及大小
		siteNameCombo = new AJComboBox(true, this,
				ComponentConst.SITENAME_COMBOBOX_NAME, 80, 40, 120, 30, 14,
				siteNames);
		typeNameCombo = new AJComboBox(true, this,
				ComponentConst.TYPENAME_COMBOBOX_NAME, 280, 40, 120, 30, 14,
				sites.get(0).getTypeName());
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (o instanceof JComboBox) {
			...
			if (ComponentConst.SITENAME_COMBOBOX_NAME.equals(combo.getName())) {
				...
				// 动态改变书籍类型的下拉选项
				comboBoxModel = new DefaultComboBoxModel(sites.get(index)
						.getTypeName());
	...
	private void setPageFieldText() {
		...
		// 动态设置页码
		startField
				.setText(sites.get(siteIndex).getTypeCurrentPage()[typeIndex]);
		endField.setText(sites.get(siteIndex).getTypeCurrentPage()[typeIndex]);
	}
