...
public class DetailWindow extends JDialog {
	...
	public JLabel taskDownSizeLabel;
	...
	public DetailWindow(PictureTable pictureTable){
		...
		JLabel l9 = new AJLabel("已下载大小：", Color.BLUE, 850, 5, 80, 110);
		taskDownSizeLabel = new AJLabel("", null, 930, 5, 60, 110);
		...
		ComponentUtil.addComponents(getContentPane(),l1, taskNameLabel, picturePane, l2, taskSubnameLabel,
				l3, l4, l5, l6, l9, l7, l8, taskLanguageLabel, taskCreateLabel, taskCompletedLabel, taskSizeLabel, urlLabel, coverUrlLabel, taskDownSizeLabel);
