...
public class SearchHistoryWindow extends JDialog {
	...
	public Map<String, String> historyMap; //key为搜索关键字，value为时间
	...
	public void loadConsoleLog(){
		...
		if(logfile.exists()){
			...
			try {
				...
				String line = null;String[] linearr;String[] linearr2;int num = 0;
				while((line = br.readLine()) != null){
					...
					if(line.contains("&f_search=")){
						try{
							...
							if(linearr.length > 1 && linearr2.length > 1){
								num ++;
